<template>
  <button
    ...
    :class="[
      ...
      modelValue ? 'bg-gradient-to-r from-orange-400 to-orange-500 focus:ring-orange-500' : 'bg-gray-200 focus:ring-gray-400'
    ]"
    @click="toggle"
  >
    ...
    <span
      :class="[
        ...
        modelValue ? 'translate-x-9' : 'translate-x-1'
      ]"
    >
      <span
        v-if="modelValue"
      ...
      >
        <svg class="h-3 w-3 text-orange-500" fill="currentColor" viewBox="0 0 12 12">
